...
![image1](/svc1.png) <!-- move svc1.png from src/assets/images into public/ for production -->

![image2](/gpgp2.png) <!-- move gpgp2.png from src/assets/images into public/ for production -->
